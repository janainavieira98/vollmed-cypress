...
// Get All
export const especialistas = async (req, res) => {
...
export const criarEspecialista = async (req, res) => {
    ...
    const especialista = new Especialista(nome, crm, imagem, estaAtivo, especialidade, email, telefone, possuiPlanoSaude, planosSaude, senhaCriptografada);
...
// Get By Id
export const especialistaById = async (req, res) => {
    const { id } = req.params;
...
// Put especialista/:id
export const atualizarEspecialista = async (req, res) => {
...
export const apagarEspecialista = async (req, res) => {
    const { id } = req.params;
...
export const atualizaContato = async (req, res) => {
    const { id } = req.params;
    const buscaEspecialista = await AppDataSource.manager.findOneBy(Especialista, { id });
...
export const buscarEspecialistas = async (req, res) => {
    ...
    const especialistas = await AppDataSource.manager.find(Especialista, {
        ...
        where: especialidade ? { especialidade: especialidade } : undefined, relations: ['endereco']
    });
