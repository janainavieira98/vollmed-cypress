...
export const criarClinica = async (req, res) => {
    const { endereco, nome, email, senha, planoDeSaudeAceitos } = req.body;
...
export const atualizarClinica = async (req, res) => {
...
export const listaEspecialistasPorClinica = async (req, res) => {
    const { id } = req.params;
    const clinica = await AppDataSource.manager.findOne(Clinica, {
        where: { id },
...
export const atualizaEspecialistaPeloIdDaClinica = async (req, res) => {
    const { id } = req.params;
...
export const deletarClinica = async (req, res) => {
    const { id } = req.params;
    const clinica = await AppDataSource.manager.findOne(Clinica, {
        where: { id },
        relations: ['endereco']
