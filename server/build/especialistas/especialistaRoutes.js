...
import { especialistas, criarEspecialista, especialistaById, atualizarEspecialista, apagarEspecialista, atualizaContato, buscarEspecialistas } from './especialistaController.js';
...
especialistaRouter.put('/:id', verificaTokenJWT(Role.especialista), atualizarEspecialista);
especialistaRouter.delete('/:id', verificaTokenJWT(Role.clinica, Role.especialista), apagarEspecialista);
